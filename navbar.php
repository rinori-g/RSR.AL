<div class="header-bar">
	...
	<nav class="main-navigation">
		...
		<ul class="menu">
			...
			<li class="menu-item menu-dropdown <?php ($currentpage=='products') ? print('current-menu-item') : '' ?>"><a href="">Products</a>
				<ul class="dropdown">
			...
			<li class="menu-item <?php ($currentpage=='en') ? print('current-menu-item') : '' ?>"><a href="en">EN</a></li>
		</ul>
	</nav>
