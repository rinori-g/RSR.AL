                                ...
                                f.is("img")
                                    ...
                                    : ((e = new Image()),
                                      (e.onload = a.proxy(function () {
                                          f.css({ "background": "url(" + g + ") no-repeat center center/cover", opacity: "1" }), this._core.trigger("loaded", { element: f, url: g }, "lazy");
                                      }, this)),
                                      (e.src = g));
                        }, this)
                    ),
                ...
                var d,
                    ...
                    l = function (a) {
                        (e = '<div class="owl-video-play-icon"></div>'),
                            (d = k.lazyLoad ? '<div class="owl-video-tn ' + j + '" ' + i + '="' + a + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background:url(' + a + ') no-repeat center center/cover"></div>'),
                            b.after(d),
                            b.after(e);
                    };
                return (
...
+(function () {
    ...
    $(elBgImg).each(function () {
        ...
        $(this).css("background", "url(" + image + ") no-repeat center center/cover");
    });
